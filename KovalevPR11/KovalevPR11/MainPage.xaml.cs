...
namespace KovalevPR11
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            var rnd = new Random();
            var data = new[] { "Группа: ПКС-31", "ФИО: Ковалев Дмитрий Михайлович", "Программист со стажем", "Безработный", "В активном поиске", $"Сегодня:{DateTime.Now}" };
